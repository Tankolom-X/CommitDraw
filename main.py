...
def description_of_exclude_days():
    ...
    print('Saturday - 6')
    print_line()
    print('!!!Insert numbers of days of the week in a line separated by a space!!!')
    print_line()
    print('Example: 0 6')
    print_line()
    print()
...
def description_of_settings():
    ...
    print_line()
    print('!!!All settings must be inserted in a line separated by a space!!!')
    print_line()
    print('Example: 1*2 2-4 7    -- this means number 1 commit will appear with frequency 2\n'
          '                      -- numbers from 2 to 4\n'
          '                      -- number 7')
    print()
